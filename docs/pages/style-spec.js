            ...
            <div className='col12 clearfix pad0y pad2x'>
                ...
                <div>
                    <em className='inline quiet'>
                        ...
                        <a href={`#types-${this.props.type}`}>{this.props.type}</a>}.
                    </em>

                    {this.props.values && !Array.isArray(this.props.values) && // skips $root.version
                    <span className='space-right quiet'>
                            <em>One of</em> {Object.keys(this.props.values).map((opt, i) => <var
                        key={i}>{opt}</var>).join(', ')}.
                        </span>}

                    {this.props.units &&
                    <span className='space-right quiet'>
                            <em>Units in</em> <var>{this.props.units}</var>.
                        </span>}

                    {this.props.default !== undefined &&
                    <span className='space-right quiet'>
                            <em>Defaults to </em> <var>{JSON.stringify(this.props.default)}</var>.
                        </span>}

                    {this.props.requires &&
                    <span className='space-right quiet'>
                            {this.props.requires.map((r, i) => this.requires(r, i))}
                        </span>}
                </div>
                ...
                <div className='space-bottom1'>
                    <dl>
                        {Object.entries(this.props.values).map(([v, {doc}], i) =>
                ...
                <div className='space-bottom1 clearfix'>
                    {`"${this.props.name}": ${JSON.stringify(this.props.example, null, 2)}`}
                </div>}
                ...
                <div className='space-bottom2'>
                    <table className='micro fixed'>
                        ...
                        <tbody>
                        {Object.entries(this.props['sdk-support']).map(([key, entry], i) =>
                            <tr key={i}>
                                <td>{md(key)}</td>
                    ...
                    <div className='contain margin3 col9'>
                        ...
                        <div className='prose'>
                            ...
                            <div className='pad2 keyline-all fill-white'>
                                {Object.entries(ref.$root).map(([name, prop], i) =>
                        ...
                        <div className='pad2 prose'>
                            ...
                            <div className='pad2 keyline-all fill-white'>
                                {Object.entries(ref.light).map(([name, prop], i) =>
                        ...
                        <div className='pad2 prose'>
                            ...
                            <p>
                                ...
                                <var>{sourceTypes.join('</var>, <var>')}</var>. Adding a source
                            ...
                            <div className='space-bottom4 fill-white keyline-all'>
                                <div id='sources-vector' className='pad2 keyline-bottom'>
                                    ...
                                    <div className='space-bottom1 clearfix'>
                                        { Object.entries(ref.source_tile).map(([name, prop], i) =>
                        ...
                        <div className='pad2 prose'>
                            ...
                            <div className='pad2 keyline-all fill-white'>
                                { Object.entries(ref.transition).map(([name, prop], i) =>
                        ...
                        <div className='pad2 prose'>
                            ...
                            <p>
                                ...
                                layer is specified by the <code>"type"</code> property, and must be one of <var>{layerTypes.join(', ')}</var>.
                            </p>
                            <p>
                            ...
                            <div className='pad2 keyline-all fill-white'>
                                { Object.entries(ref.layer).map(([name, prop], i) =>
                        ...
                        <div className='pad2 prose'>
                            ...
                            <p className='space-bottom4 quiet small'>Key:
                                <a className='icon smooth-ramp quiet micro space-right inline' href='#types-expression-curve' title='Supports all interpolation types'>supports all interpolation types</a>
                                <a className='icon step-ramp quiet micro space-right inline' href='#types-expression-curve' title='Supports step interpolation only'>supports "step" interpolation only</a>
                                    ...
                                    <div key={i} id={`layers-${t}`} className='pad2 keyline-bottom'>
                                        ...
                                        <div>
                                            ...
                                            { Object.keys(ref[`layout_${t}`]).length === 0 ?
                                                ...
                                                Object.entries(ref['layout_'+t]).map(([name, prop], i) =>
                                        ...
                                        <div>
                                            ...
                                            { Object.entries(ref[`paint_${t}`]).map(([name, prop], i) =>
                        ...
                        <div className='pad2 prose'>
                            ...
                            <p>The value for any <a href="#layer-layout">layout property</a>, <a
                                ...
                                href="#layer-filter">filter</a> may be specified as an
                                <em>expression</em>. Expressions define how one or more feature
                            ...
                            <p>Any zoom expression used in a layout or paint property must be of the following form (see
                                <a href="#types-expression-curve">curves</a> for more details):</p>
                            ...
                            <p>That is, in layout or paint properties, <code>["zoom"]</code> may only appear as the
                                input to an outer <a href="#types-expression-curve">curve</a>, and may not appear
                                anywhere else in the expression.</p>
                            ...
                            <div className='keyline-all fill-white'>
                                {/*{groupedExpressions.map((group, i) =>*/}
                                    {/*<div className='pad2 keyline-bottom'>*/}
                                        {/*<h4 style='font-size: 100%' class="pad2x">*/}
                                            {/*<a id={`expressions-${slug(group.name)}`} href={`#expressions-${slug(group.name)}`}>{group.name}</a>*/}
                                        {/*</h4>*/}
                                        {/*{group.expressions.map((expression, i) => renderExpression(expression))}*/}
                                    {/*</div>*/}
                                {/*)}*/}
                            </div>
                        </div>
